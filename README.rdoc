...
== Usage
 ...
 m.tokenize_text("Here in the U.S. Senate we prefer to eat our friends. Is it easier that way, really? <em>Yes.</em> <em>Maybe</em>?")
 #=> ["Here in the U.S. Senate we prefer to eat our friends.", "Is it easier that way, really?", "<em>Yes.</em>", "<em>Maybe</em>?"]
